...
public class TabLayout extends HorizontalScrollView {
    ...
    public static final int INDICATOR_WIDTH_MARCH = 0;
    public static final int INDICATOR_WIDTH_WRAP = 1;
    public static final int INDICATOR_WIDTH_CUSTOM = 2;


    @IntDef(
            value = {
                    INDICATOR_WIDTH_MARCH,
                    INDICATOR_WIDTH_WRAP,
                    INDICATOR_WIDTH_CUSTOM
            }
    )
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        slidingTabIndicator.setSelectedIndicatorWidth(a.getDimensionPixelSize(R.styleable.TabLayout_tabIndicatorWidth, -1));
        ...
        setSelectedTabIndicatorWidthMode(a.getInt(R.styleable.TabLayout_tabIndicatorWidthMode, INDICATOR_WIDTH_MARCH));
    ...
    public void setSelectedTabIndicatorWidthMode(@TabIndicatorWidthMode int indicatorWidthMode) {
        if (tabIndicatorWidthMode != indicatorWidthMode) {
            tabIndicatorWidthMode = indicatorWidthMode;
            ViewCompat.postInvalidateOnAnimation(slidingTabIndicator);
        }
    }


    public int getTabIndicatorWidthMode() {
        return tabIndicatorWidthMode;
    }
    ...
    private class SlidingTabIndicator extends LinearLayout {
        ...
        private void updateIndicatorPosition() {
            ...
            if (selectedTitle != null && selectedTitle.getWidth() > 0 && selectedPosition < childCount) {
                ...
                if (!tabIndicatorFullWidth && selectedTitle instanceof TabView) {
                    ...
                    if (tabIndicatorWidthMode == INDICATOR_WIDTH_WRAP) {
                ...
                if (selectedIndicatorWidth > 0 && tabIndicatorWidthMode == INDICATOR_WIDTH_CUSTOM) {
                    selectedIndicatorWidth = Math.min(selectedTitle.getWidth(), selectedIndicatorWidth);
                    selectedIndicatorWidth = Math.min(nextTitle.getWidth(), selectedIndicatorWidth);

                    left = left + (selectedTitle.getWidth() - selectedIndicatorWidth) / 2;
                    nextTitleLeft = nextTitleLeft + (nextTitle.getWidth() - selectedIndicatorWidth) / 2;
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            if (!tabIndicatorFullWidth && targetView instanceof TabView) {
                ...
                targetViewWidth = targetRight - targetLeft;
            }
